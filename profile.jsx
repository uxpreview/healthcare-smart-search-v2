  ...
  return (
    <div className="ptab">
      ...
      <div className="privacy-block">
        ...
        <p className="privacy-block__body">Your care profile is visible only to you and is never sold. If you choose to book an appointment, relevant details may be shared with that facility's care team to streamline your visit.</p>
      </div>
      <div className="privacy-block">
        <PToggle
          label="Use care profile to personalize search results"
          value={personalizeOn}
      ...
      <div className="privacy-block privacy-block--last">
        ...
        <div className="privacy-actions">
          <button className="btn">Export profile data</button>
          <button className="btn privacy-btn--danger"
            onClick={() => window.confirm('Delete all care profile data? This cannot be undone.') && onDelete()}>
...
const PROFILE_DEFAULTS = {
  basics:      { name: 'Ryan McCarty', dob: '1989-04-12', pronouns: 'he/him', email: 'ryankmccarty@icloud.com', phone: '', contactMethod: 'email' },
  ...
  return (
    <div className="care-profile fade-in">
      <div className="care-profile__head">
        ...
        <h1 className="care-profile__title">Care profile</h1>
    ...
    <div className="prefs fade-in">
      <div className="prefs__head">
        ...
        <p className="prefs__sub">
          ...
          <button className="prefs__link" onClick={onCancel}>Care profile</button>.
        </p>
      </div>
